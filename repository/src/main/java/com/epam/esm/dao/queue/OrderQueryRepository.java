...
public class OrderQueryRepository {
    public final static String SELECT_ORDERS_BY_USERS_ID = "SELECT id, users_id, cost, order_date FROM orders LIMIT ?, ?";

    public final static String SELECT_ORDERS_CERTIFICATES_IDS =
            "SELECT certificate_id FROM certificate_orders WHERE order_id = ?";

    public final static String CREATE_ORDER_SIGN = "INSERT INTO orders(users_id, cost, order_date) VALUES (?, ?)";
